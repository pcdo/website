 ...
 */
 // Much simplified - skip all but the start
?>
<div class="event-nodeapi">
  <div class="<?php print $node_type ?>-start dtstart" title="<?php print $start_date_utc ?>"><label><?php print 'Event on ' ?> </label> <?php print "$start_date_formatted $start_time_formatted" ?> </div>
</div>
